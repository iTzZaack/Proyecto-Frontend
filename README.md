...
Proyecto de Front-End para la carrera de Desarrollo de Software. Permite crear, editar, eliminar y consultar eventos, registrar asistentes, filtrar por categoría y ver estadísticas de participación.
...
2. **Registro de asistentes:** sumar participantes hasta llegar al cupo máximo.
3. **Búsqueda y filtros:** por título, lugar y categoría (Conferencia, Taller, Deportes, Social).
4. **Estadísticas:** total de eventos, asistentes registrados y cupos disponibles.
...
├── main.jsx
└── index.css              # tokens de Tailwind (colores, tipografías)
```
...
## Autor
Proyecto desarrollado para CENESTUR - Carrera de Desarrollo de Software.
